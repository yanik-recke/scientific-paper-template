...
\newcommand{\titel}{Is Cybersecurity Research Missing a Trick? Integrating Insights From the  Psychology of Habit Into Research and Practice}
\newcommand{\untertitel}{}
\newcommand{\thesisname}{Term Paper}
\newcommand{\Datum}{30. May 2025}
\newcommand{\authorname}{Yanik Luis Recke}
%%%%%%%%%%%%%%%%%%%  Document info  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\xpatchbibdriver{online}{\usebibmacro{finentry}}{\def\finentrypunct{}\usebibmacro{finentry}}{}{\fail}
\DefineBibliographyStrings{english}{url = [Online]\adddot\addspace Available}
...
\lstdefinelanguage{Vue}{
    language={html},
    morekeywords={template, ref, import, const}
}
